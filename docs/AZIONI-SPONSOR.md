...
A-12|L'Unità A si alimenta da una presa esistente o serve un circuito nuovo?|Gate installazione Unità A|-|Se serve un circuito nuovo NON è fai-da-te: D.M. 37/2008 impone impresa abilitata e dichiarazione di conformità. Scoprirlo dopo significa rifare l'impianto. SUBORDINATA A A-20: con D-29 l'Unità A è a batteria, quindi questa azione serve solo se la ricarica sarà una presa di servizio.|aperta
A-13|Verificare se c'è un differenziale da 30 mA sul circuito del balcone|Gate installazione Unità A|-|Alimentazione in esterno senza differenziale adeguato è il rischio elettrico principale del progetto. SUBORDINATA A A-20: con D-29 l'Unità A è a batteria, quindi serve solo se la ricarica sarà una presa di servizio o un caricabatterie fisso sul balcone.|aperta
